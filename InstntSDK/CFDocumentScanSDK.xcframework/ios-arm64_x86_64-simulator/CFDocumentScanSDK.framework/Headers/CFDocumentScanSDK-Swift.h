...
enum DSMRZCaptureMethod : NSInteger;
...
@property (nonatomic) BOOL detectBarcodeOrMRZ SWIFT_DEPRECATED_MSG("Use mrzCaptureMethod and detectBarcode instead");
...
@property (nonatomic) BOOL detectBarcode;
/// The method in which the Machine-Readable Zone should be captured, if at all. Defaults to <code>.detect</code>.
@property (nonatomic) enum DSMRZCaptureMethod mrzCaptureMethod;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
/// The Machine-Readable Zone appears on travel documents such as passports or passport cards.
/// The MRZ will always be two or three lines and is often placed near the bottom of the document.
/// Example:
/// P<UTOERIKSSON<<ANNA<MARIA<<<<<<<<<<<<<<<<<<<
/// L898902C<3UTO6908061F9406236ZE184226B<<<<<14
/// important:
/// For documents without an MRZ, <code>.ignore</code> should be used. When you need the MRZ, use <code>.recognize</code>.
/// When you only need to verify that the MRZ exists, <code>.detect</code> is slightly faster.
typedef SWIFT_ENUM(NSInteger, DSMRZCaptureMethod, open) {
/// MRZ is not detected at all during capture
  DSMRZCaptureMethodIgnore = 0,
/// MRZ is detected, but not fully recognized
  DSMRZCaptureMethodDetect = 1,
/// MRZ is recognized, decoded, and included in the final result
  DSMRZCaptureMethodRecognize = 2,
};
...
@property (nonatomic) BOOL detectMRZ SWIFT_DEPRECATED_MSG("Use mrzCaptureMethod instead");
/// The method in which the Machine-Readable Zone should be captured, if at all. Defaults to <code>.detect</code>.
@property (nonatomic) enum DSMRZCaptureMethod mrzCaptureMethod;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
